...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rango_category', (
            ...
            ('views', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=11)),
            ('likes', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=11)),
        ))
    ...
    models = {
        u'rango.category': {
            ...
            'likes': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '11'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'views': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '11'})
        },
        u'rango.page': {
